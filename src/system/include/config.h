...
#define NANOMIND      ///< X86 | RPI | GROUNDSTATION | ESP32 | AVR32 | NANOMIND
...
#define SCH_NAME                "PLANTSAT"         ///< Project code name
#define SCH_DEVICE_ID           4             ///< Device unique ID
#define SCH_SW_VERSION          "2.1.5-4-g2c4f"      ///< Software version
...
#define SCH_STORAGE_PGUSER      "gdiazh"
