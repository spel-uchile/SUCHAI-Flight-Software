...
if(SCH_STORAGE_MODE STREQUAL "SCH_ST_POSTGRES")
    set(SCH_STORAGE_PGUSER \"${SCH_ST_PGUSER}\")
    set(SCH_STORAGE_PGPASS \"${SCH_ST_PGPASS}\")
    set(SCH_STORAGE_PGHOST \"${SCH_ST_PGHOST}\")
    set(SCH_STORAGE_PGPORT ${SCH_ST_PGPORT})
    set(SCH_STORAGE_PGDBNAME \"${SCH_ST_PGDBNAME}\")
    set(SCH_STORAGE_PGLIB ${SCH_ST_PGLIB})
endif()
...
#set(SCH_STORAGE_PGPORT 0 CACHE STRING "PSQL Port, only if @SCH_STORAGE_MODE is SCH_ST_POSTGRES")
...
#set(SCH_STORAGE_PGLIB 0 CACHE PATH "PSQL lib headers, only if @SCH_STORAGE_MODE is SCH_ST_POSTGRES")